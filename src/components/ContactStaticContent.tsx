...
export default function ContactStaticContent({ language }: ContactStaticContentProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-7xl">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {/* Contact Information - SEO Important */}
        <div>
        ...
        {/* Form placeholder - will be enhanced client-side */}
        <div>
          <Card className="border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-slate-700 dark:text-slate-300">
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                {/* Static content for form - will be enhanced with interactive form client-side */}
                <div className="text-center py-8">
                  <p className="text-neutral-500 dark:text-neutral-500">
                    {language === 'en' ? 'Loading contact form...' : 'Se încarcă formularul de contact...'}
                  </p>
                </div>
              </div>
            </CardContent>
