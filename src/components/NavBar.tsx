    ...
    >
      ...
      >
        <Link href="/" className="flex items-center space-x-2">
          ...
          <span className="font-medium text-gray-900 dark:text-white">Lagrange Engineering</span>
        </Link>
